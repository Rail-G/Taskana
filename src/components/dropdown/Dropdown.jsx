...
export default function Dropdown() {
  ...
  return (
    <div className={styles.block}>
      <button
        className={`${btnStyle} ${unSelect && styles.unSelected}`}
        ...
        <ul className={styles.sortList}>
          <li>
            <button
              ...
              onClick={(event) =>
                onClickListItem(event, "Приоритету", "priority", "asc")
              }
              name="fromUnimportant"
            >
              <Icon name="fromUnimportant" />
              Приоритету
              {selected == "fromUnimportant" && (
                <span>
                  <Icon name="check" />
                </span>
              )}
          ...
          <li>
            <button
              className={styles.sortButton}
              onClick={(event) =>
                onClickListItem(event, "Приоритету", "priority", "desc")
              }
              name="ofImportance"
            >
              <Icon name="ofImportance" />
              Приоритету
              {selected == "ofImportance" && (
                <span>
                  <Icon name="check" />
                </span>
              )}
          ...
          <li>
            <button
              className={styles.sortButton}
              onClick={(event) =>
                onClickListItem(event, "Алфавиту", "alphabet", "asc")
              }
              name="downAlphabet"
            >
              <Icon name="downAlphabet" />
              Алфавиту
              {selected == "downAlphabet" && (
                <span>
                  <Icon name="check" />
                </span>
              )}
          ...
          <li>
            <button
              className={styles.sortButton}
              onClick={(event) =>
                onClickListItem(event, "Алфавиту", "alphabet", "desc")
              }
              name="upAlphabet"
            >
          ...
          <li>
            <button
              className={styles.sortButton}
              onClick={(event) =>
                onClickListItem(event, "Дате создания", "create", "asc")
              }
              name="downDate"
            >
              <Icon name="downDate" />
          ...
          <li>
            <button
              className={styles.sortButton}
              onClick={(event) =>
                onClickListItem(event, "Дате создания", "create", "desc")
              }
              name="upDate"
            >
              <Icon name="upDate" />
          ...
          <li>
            <button
              className={styles.sortButton}
              onClick={(event) =>
                onClickListItem(event, "Дате обновления", "update", "asc")
              }
              name="newOld"
            >
              <Icon name="newOld" />
          ...
          <li>
            <button
              className={styles.sortButton}
              onClick={(event) =>
                onClickListItem(event, "Дате обновления", "update", "desc")
              }
              name="oldNew"
            >
              <Icon name="oldNew" />
